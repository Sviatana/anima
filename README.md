...
**Anima** — backend-проект на Python, который используется как база для сервисов с API, автоматизаций и AI-интеграций.  
Репозиторий показывает организацию backend-архитектуры, работу с БД, окружением, деплоем и CI/CD.
